...
void receiver_restore_state(RECEIVER *rx)
{
  ...
  value = getProperty(name);
  if (value)
    rx->sample_rate = atol(value);
  sprintf(name, "receiver[%d].dsp_rate", rx->channel);
  value = getProperty(name);
  if (value)
    rx->dsp_rate = atol(value);
  sprintf(name, "receiver[%d].output_rate", rx->channel);
  value = getProperty(name);
  if (value)
    rx->output_rate = atol(value);

  sprintf(name, "receiver[%d].frequency_a", rx->channel);
  value = getProperty(name);
  if (value)
    rx->frequency_a = atol(value);
  sprintf(name, "receiver[%d].lo_a", rx->channel);
  value = getProperty(name);
  if (value)
    rx->lo_a = atol(value);
  ...
  value = getProperty(name);
  if (value)
    rx->error_tx = atol(value);
  sprintf(name, "receiver[%d].tx_track_rx", rx->channel);
  value = getProperty(name);
  if (value)
    rx->tx_track_rx = atoi(value);
  sprintf(name, "receiver[%d].error_a", rx->channel);
  value = getProperty(name);
  if (value)
    rx->error_a = atol(value);
  sprintf(name, "receiver[%d].band_a", rx->channel);
  value = getProperty(name);
  if (value)
    rx->band_a = atoi(value);
  sprintf(name, "receiver[%d].mode_a", rx->channel);
  value = getProperty(name);
  if (value)
    rx->mode_a = atoi(value);
  sprintf(name, "receiver[%d].filter_a", rx->channel);
  value = getProperty(name);
  if (value)
    rx->filter_a = atoi(value);
  sprintf(name, "receiver[%d].filter_low_a", rx->channel);
  value = getProperty(name);
  if (value)
    rx->filter_low_a = atoi(value);
  sprintf(name, "receiver[%d].filter_high_a", rx->channel);
  value = getProperty(name);
  if (value)
    rx->filter_high_a = atoi(value);
  sprintf(name, "receiver[%d].frequency_b", rx->channel);
  value = getProperty(name);
  if (value)
    rx->frequency_b = atol(value);
  sprintf(name, "receiver[%d].lo_b", rx->channel);
  value = getProperty(name);
  if (value)
    rx->lo_b = atol(value);
  ...
  value = getProperty(name);
  if (value)
    rx->error_b = atol(value);
#ifdef USE_VFO_B_MODE_AND_FILTER
  sprintf(name, "receiver[%d].band_b", rx->channel);
  value = getProperty(name);
  if (value)
    rx->band_b = atoi(value);
  sprintf(name, "receiver[%d].mode_b", rx->channel);
  value = getProperty(name);
  if (value)
    rx->mode_b = atoi(value);
  sprintf(name, "receiver[%d].filter_b", rx->channel);
  value = getProperty(name);
  if (value)
    rx->filter_b = atoi(value);
  sprintf(name, "receiver[%d].filter_low_b", rx->channel);
  value = getProperty(name);
  if (value)
    rx->filter_low_b = atoi(value);
  sprintf(name, "receiver[%d].filter_high_b", rx->channel);
  value = getProperty(name);
  if (value)
    rx->filter_high_b = atoi(value);
#endif
  ...
  value = getProperty(name);
  if (value)
    rx->ctun_offset = atol(value);
  sprintf(name, "receiver[%d].ctun_frequency", rx->channel);
  value = getProperty(name);
  if (value)
    rx->ctun_frequency = atol(value);
  sprintf(name, "receiver[%d].ctun_min", rx->channel);
  value = getProperty(name);
  if (value)
    rx->ctun_min = atol(value);
  sprintf(name, "receiver[%d].ctun_max", rx->channel);
  value = getProperty(name);
  if (value)
    rx->ctun_max = atol(value);

  sprintf(name, "receiver[%d].qo100_beacon", rx->channel);
  value = getProperty(name);
  if (value)
    rx->qo100_beacon = atoi(value);
  ...
  value = getProperty(name);
  if (value)
    rx->local_audio_latency = atoi(value);
  sprintf(name, "receiver[%d].audio_channels", rx->channel);
  value = getProperty(name);
  if (value)
    rx->audio_channels = atoi(value);
  ...
  value = getProperty(name);
  if (value)
    rx->enable_equalizer = atoi(value);
  for (i = 0; i < 4; i++)
  {
    sprintf(name, "receiver[%d].equalizer[%d]", rx->channel, i);
    value = getProperty(name);
    if (value)
      rx->equalizer[i] = atoi(value);
  }

  sprintf(name, "receiver[%d].rit_enabled", rx->channel);
  value = getProperty(name);
  if (value)
    rx->rit_enabled = atoi(value);
  sprintf(name, "receiver[%d].rit", rx->channel);
  value = getProperty(name);
  if (value)
    rx->rit = atol(value);
  ...
  value = getProperty(name);
  if (value)
    rx->rit_step = atol(value);

  sprintf(name, "receiver[%d].bpsk_enable", rx->channel);
  value = getProperty(name);
  if (value)
    rx->bpsk_enable = atoi(value);
  ...
  value = getProperty(name);
  if (value)
    rx->display_average_time = atof(value);
  ...
  value = getProperty(name);
  if (value)
    rx->panadapter_filled = atoi(value);
  sprintf(name, "receiver[%d].panadapter_gradient", rx->channel);
  value = getProperty(name);
  if (value)
    rx->panadapter_gradient = atoi(value);
  sprintf(name, "receiver[%d].panadapter_agc_line", rx->channel);
  value = getProperty(name);
  if (value)
    rx->panadapter_agc_line = atoi(value);
  ...
  value = getProperty(name);
  if (value)
    rx->waterfall_ft8_marker = atoi(value);
  ...
  value = getProperty(name);
  if (value)
    rx->duplex = atoi(value);
  sprintf(name, "receiver[%d].mute_while_transmitting", rx->channel);
  value = getProperty(name);
  if (value)
    rx->mute_while_transmitting = atoi(value);

  sprintf(name, "receiver[%d].rigctl_port", rx->channel);
  value = getProperty(name);
  if (value)
    rx->rigctl_port = atoi(value);
  sprintf(name, "receiver[%d].rigctl_enable", rx->channel);
  value = getProperty(name);
  if (value)
    rx->rigctl_enable = atoi(value);
  sprintf(name, "receiver[%d].rigctl_serial_enable", rx->channel);
  value = getProperty(name);
  if (value)
    rx->rigctl_serial_enable = atoi(value);
  sprintf(name, "receiver[%d].rigctl_serial_port", rx->channel);
  value = getProperty(name);
  if (value)
    strcpy(rx->rigctl_serial_port, value);
  sprintf(name, "receiver[%d].rigctl_debug", rx->channel);
  value = getProperty(name);
  if (value)
    rx->rigctl_debug = atoi(value);

  sprintf(name, "receiver[%d].paned_position", rx->channel);
  value = getProperty(name);
  if (value)
    rx->paned_position = atoi(value);

  sprintf(name, "receiver[%d].paned_percent", rx->channel);
  value = getProperty(name);
  if (value)
    rx->paned_percent = atof(value);
}
...
static void create_visual(RECEIVER *rx)
{
  ...
  gtk_widget_set_events(rx->window, gtk_widget_get_events(rx->window) | GDK_FOCUS_CHANGE_MASK | GDK_BUTTON_PRESS_MASK | GDK_BUTTON_RELEASE_MASK);
}
...
RECEIVER *create_receiver(int channel, int sample_rate)
{
  ...
  #ifdef _WIN32
  rx->rigctl_serial_baudrate = CBR_9600;
  #else
