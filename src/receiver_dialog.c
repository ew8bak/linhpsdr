...
#ifdef _WIN32
  case 0:
    rx->rigctl_serial_baudrate = CBR_4800;
    break;
  case 1:
    rx->rigctl_serial_baudrate = CBR_9600;
    break;
  case 2:
    rx->rigctl_serial_baudrate = CBR_19200;
    break;
  case 3:
    rx->rigctl_serial_baudrate = CBR_38400;
    break;
#else
  case 0:
